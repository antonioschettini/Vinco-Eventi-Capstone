...
public record QuoteRequestDTO(
        ...
        @Pattern(
                regexp = "^[^,=<>;$%\\*|\\\\{}]{2,80},\\s*[^,=<>;$%\\*|\\\\{}]{2,50}$",
                message = "Il luogo dell'evento deve contenere Nome Struttura e Città/Località validi separati da virgola (es. Masseria Coccaro, Monopoli), senza simboli speciali o numeri di injection"
        )
        String location,
