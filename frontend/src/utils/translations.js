  ...
  it: {
    ...
    contactForm: {
      ...
      validationGuidance: {
        ...
        cittaLocation: "Inserisci la città o località dell'evento (es. Roma).",
  ...
  en: {
    ...
    contactForm: {
      ...
      validationGuidance: {
        ...
        cittaLocation: "Please enter a valid city or town (e.g. Rome).",
