...
const ALL_REVIEWS_POOL = [
  ...
  },
  {
    ...
    name: "Fabio & Valeria",
    dateIta: "12/09/2025",
    dateEng: "September 12, 2025",
    rating: 5.0,
    titleIta: "Live Band ed energia allo stato puro!",
    titleEng: "Live Band and pure energetic vibes!",
    textIta: "La band dal vivo ha conquistato tutti durante il banchetto e il DJ set finale ha chiuso la serata con fuochi d'artificio e tanto divertimento. Straordinari!",
    textEng: "The live band captivated everyone during the dinner and the final DJ set closed the night with fireworks and non-stop dancing. Extraordinary!",
    initials: "F",
  },
  {
    id: 16,
    name: "Christian & Noemi",
    dateIta: "20/06/2025",
    dateEng: "June 20, 2025",
    rating: 5.0,
    titleIta: "Cerimonia emozionante e festa travolgente",
    titleEng: "Emotional ceremony and vibrant celebration",
    textIta: "L'arpa e il violino durante la cerimonia hanno fatto commuovere tutti. Poi alla location il ritmo è salito e la festa è decollata. Grazie Vincenzo!",
    textEng: "Harp and violin during our ceremony moved everyone to tears. Then at the venue the rhythm picked up and the party took off. Thank you Vincenzo!",
    initials: "C",
  },
  {
    id: 17,
    name: "Antonio & Federica",
    dateIta: "05/08/2025",
    dateEng: "August 5, 2025",
    rating: 5.0,
    titleIta: "Scenografia luci e fontane sparkular da sogno",
    titleEng: "Dream lighting design and sparkular fountains",
    textIta: "Oltre alla musica eccellente, il service luci e le fontane luminose durante il taglio della torta hanno creato uno scenario fiabesco. Servizio impeccabile!",
    textEng: "Beyond the excellent music, the scenic lighting and sparkular cold fountains during cake cutting created a fairytale scene. Flawless service!",
    initials: "A",
  },
  {
    id: 18,
    ...
    dateEng: "May 24, 2025",
    rating: 5.0,
    titleIta: "Vocalist e Sax: abbinamento vincente!",
    titleEng: "Vocalist and Sax: a winning combination!",
    textIta: "L'aperitivo con sax e voce dal vivo è stato di una raffinatezza unica. Poi il DJ set ha tenuto la pista piena per quattro ore consecutive!",
    textEng: "Cocktail hour with live sax and vocals was uniquely sophisticated. Then the DJ set kept the dancefloor packed for four straight hours!",
    initials: "S",
  },
  {
    id: 19,
    name: "Davide & Chiara",
    dateIta: "18/10/2024",
    dateEng: "October 18, 2024",
    rating: 5.0,
    titleIta: "Regia impeccabile e serenità assoluta",
    titleEng: "Flawless direction and total peace of mind",
    textIta: "Vincenzo ha coordinato tutti i momenti musicali con precisione chirurgica. Abbiamo vissuto la giornata senza alcuna preoccupazione!",
    textEng: "Vincenzo coordinated all musical moments with pinpoint accuracy. We enjoyed our wedding day with absolute peace of mind!",
    initials: "D",
  },
  {
    id: 20,
    name: "Michele & Annalisa",
    dateIta: "30/07/2024",
    dateEng: "July 30, 2024",
    rating: 5.0,
    titleIta: "Tutti gli ospiti ci hanno fatto i complimenti!",
    titleEng: "All our guests gave us endless compliments!",
    textIta: "Dalla prima consulenza alla fine della festa, disponibilità e professionalità al 100%. Reperorio perfetto che ha accontentato grandi e ragazzi.",
    textEng: "From the initial consultation to the very end of the party, 100% availability and professionalism. Perfect playlist pleasing all generations.",
    initials: "M",
  },
  {
    id: 21,
    name: "Luca & Sara",
    dateIta: "15/06/2024",
    dateEng: "June 15, 2024",
    rating: 5.0,
    titleIta: "Consulenza musicale eccellente",
    titleEng: "Outstanding musical consultation",
    textIta: "Ci hanno guidato nella scelta dei brani giusti per ogni passaggio importante del nostro matrimonio in masseria. Risultato oltre le aspettative!",
    textEng: "They guided us in choosing the right songs for every key moment of our Masseria wedding. The result was beyond our expectations!",
    initials: "L",
  },
  {
    id: 22,
    name: "Paolo & Beatrice",
    dateIta: "02/09/2023",
    dateEng: "September 2, 2023",
    rating: 5.0,
    titleIta: "Acustica perfetta e atmosfera magica",
    titleEng: "Crystal-clear acoustics and magical vibe",
    textIta: "Impianto audio di altissima qualità, audio bilanciato senza mai risultare fastidioso a tavola, e potenza straordinaria all'after party!",
    textEng: "High-end sound equipment, well-balanced audio that was never intrusive at dinner, and incredible punch for the late-night after-party!",
    initials: "P",
  },
  {
    id: 23,
    name: "Vincenzo & Giorgia",
    dateIta: "22/07/2023",
    dateEng: "July 22, 2023",
    rating: 5.0,
    titleIta: "After party memorabile e divertimento continuo",
    titleEng: "Memorable after party and continuous fun",
    textIta: "DJ set pazzesco con transizioni perfette. Non volevamo più smettere di ballare! Consigliatissimi per chi vuole un vero party.",
    textEng: "Awesome DJ set with seamless transitions. Nobody wanted to stop dancing! Highly recommended for anyone looking for a real party.",
    initials: "V",
  },
  {
    id: 24,
    name: "Gabriele & Marta",
    dateIta: "10/06/2023",
    dateEng: "June 10, 2023",
    rating: 5.0,
    titleIta: "Emozioni uniche dalla cerimonia alla notte",
    titleEng: "Unique emotions from ceremony to late night",
    textIta: "Dalla marcia nuziale arrangiata in modo moderno fino all'ultimo disco della notte, tutto è stato curato nei minimi particolari.",
    textEng: "From the modern bridal entrance arrangement to the very last track of the night, everything was curated with utmost care.",
    initials: "G",
  },
];
