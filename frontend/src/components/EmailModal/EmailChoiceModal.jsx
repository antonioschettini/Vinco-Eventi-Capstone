        ...
        <div className="modal-content border-0 shadow-lg email-modal-content">
          ...
          <div className="modal-body pt-3 pb-4">
            ...
            <div className="d-flex flex-column gap-2">
              ...
              {/* Opzione 2: Apple Mail (Logo Ufficiale Apple) */}
              <a
                href={`mailto:${email}`}
                className="email-option-card d-flex align-items-center p-3 rounded-3 text-decoration-none transition-all"
                onClick={handleClose}
              >
                <div className="option-icon-wrapper rounded-circle bg-dark text-white shadow-sm d-flex align-items-center justify-content-center me-3" style={{ width: "42px", height: "42px", minWidth: "42px" }}>
                ...
                <div className="flex-grow-1">
                  ...
                  <div className="text-muted extra-small">{t.appleMailSub}</div>
                </div>
              </a>

              {/* Opzione 3: Outlook Web (Logo Ufficiale Microsoft 4 Colori) */}
              <a
              ...
              {/* Opzione 4: App Predefinita di Posta */}
              <a
                href={`mailto:${email}`}
                className="email-option-card d-flex align-items-center p-3 rounded-3 text-decoration-none transition-all"
                onClick={handleClose}
              ...
              {/* Opzione 5: Copia Indirizzo Email */}
              <button
                type="button"
